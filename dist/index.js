...
const Column = props => {
  const theme = useThemeContext();
  return /*#__PURE__*/React__default['default'].createElement(StyledColumn, _extends({
    className: "af-column",
    theme: theme ? theme : null
  }, props), props.children);
};
...
const Container = props => {
  const theme = useThemeContext();
  return /*#__PURE__*/React__default['default'].createElement(StyledContainer, _extends({
...
const Section = props => {
  const theme = useThemeContext();
  return /*#__PURE__*/React__default['default'].createElement(StyledSection, _extends({
...
const Heading = props => {
  const theme = useThemeContext();
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, !props.level ? /*#__PURE__*/React__default['default'].createElement(StyledH2, _extends({
    className: "af-heading"
  }, props), props.children) : Number(props.level) === 1 ? /*#__PURE__*/React__default['default'].createElement(StyledH1, _extends({
    className: "af-heading",
    theme: theme ? theme : null
  }, props), props.children) : Number(props.level) === 2 ? /*#__PURE__*/React__default['default'].createElement(StyledH2, _extends({
    className: "af-heading",
    theme: theme ? theme : null
  }, props), props.children) : Number(props.level) === 3 ? /*#__PURE__*/React__default['default'].createElement(StyledH3, _extends({
    className: "af-heading",
    theme: theme ? theme : null
  }, props), props.children) : Number(props.level) === 4 ? /*#__PURE__*/React__default['default'].createElement(StyledH4, _extends({
    className: "af-heading",
    theme: theme ? theme : null
  }, props), props.children) : Number(props.level) === 5 ? /*#__PURE__*/React__default['default'].createElement(StyledH5, _extends({
    className: "af-heading",
    theme: theme ? theme : null
  }, props), props.children) : Number(props.level) === 6 ? /*#__PURE__*/React__default['default'].createElement(StyledH6, _extends({
    className: "af-heading",
    theme: theme ? theme : null
  }, props), props.children) : /*#__PURE__*/React__default['default'].createElement(StyledH2, _extends({
    className: "af-heading"
  }, props), props.children));
};
...
const Logo = props => {
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledLogo, _extends({
    className: "af-logo",
    onClick: handleClick,
    theme: theme ? theme : null
...
const Dropdown = props => {
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledDropdownContainer, {
    className: "af-dropdown",
    onMouseOut: handleMouseOut,
    onMouseOver: handleMouseOver
  }, /*#__PURE__*/React__default['default'].createElement(StyledDropdownAnchorWrapper, {
    className: "af-anchor-wrapper"
  }, props.anchor()), /*#__PURE__*/React__default['default'].createElement(StyledDropdown, _extends({
...
const SubMenu = props => {
  useThemeContext();
  return /*#__PURE__*/React__default['default'].createElement(StyledSubMenu, _extends({
    className: "af-submenu"
  }, props), /*#__PURE__*/React__default['default'].createElement(Menu, {
    direction: "vertical"
  }, props.children));
};
