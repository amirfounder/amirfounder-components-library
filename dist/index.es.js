import React, { useContext, createContext, useRef, useDebugValue, createElement } from 'react';
...
const Column = props => {
  const theme = useThemeContext();
  return /*#__PURE__*/React.createElement(ColumnDiv, _extends({
    className: "af-column",
    theme: theme ? theme : null
  }, props), props.children);
};
...
const Container = props => {
  const theme = useThemeContext();
  return /*#__PURE__*/React.createElement(ContainerDiv, _extends({
...
const Section = props => {
  const theme = useThemeContext();
  return /*#__PURE__*/React.createElement(SectionDiv, _extends({
...
const Heading = props => {
  const theme = useThemeContext();
  return /*#__PURE__*/React.createElement(React.Fragment, null, !props.level ? /*#__PURE__*/React.createElement(HeadingH2, _extends({
    className: "af-heading"
  }, props), props.children) : Number(props.level) === 1 ? /*#__PURE__*/React.createElement(HeadingH1, _extends({
    className: "af-heading",
    theme: theme ? theme : null
  }, props), props.children) : Number(props.level) === 2 ? /*#__PURE__*/React.createElement(HeadingH2, _extends({
    className: "af-heading",
    theme: theme ? theme : null
  }, props), props.children) : Number(props.level) === 3 ? /*#__PURE__*/React.createElement(HeadingH3, _extends({
    className: "af-heading",
    theme: theme ? theme : null
  }, props), props.children) : Number(props.level) === 4 ? /*#__PURE__*/React.createElement(HeadingH4, _extends({
    className: "af-heading",
    theme: theme ? theme : null
  }, props), props.children) : Number(props.level) === 5 ? /*#__PURE__*/React.createElement(HeadingH5, _extends({
    className: "af-heading",
    theme: theme ? theme : null
  }, props), props.children) : Number(props.level) === 6 ? /*#__PURE__*/React.createElement(HeadingH6, _extends({
    className: "af-heading",
    theme: theme ? theme : null
  }, props), props.children) : /*#__PURE__*/React.createElement(HeadingH2, _extends({
    className: "af-heading"
  }, props), props.children));
};
...
const Logo = props => {
  ...
  return /*#__PURE__*/React.createElement(LogoDiv, _extends({
    className: "af-logo",
    onClick: handleClick,
    theme: theme ? theme : null
...
const Menu = props => {
  const theme = useThemeContext();
  return /*#__PURE__*/React.createElement(MenuDiv, _extends({
    alignment: props.alignment ? props.alignment : 'left',
    className: "af-menu",
    direction: props.direction ? props.direction : 'horizontal',
    theme: theme ? theme : null
  }, props), props.children && !props.children.length && /*#__PURE__*/React.createElement(MenuChildDiv, _extends({
    alignment: props.alignment ? props.alignment : 'left',
    className: "af-menu-child",
    direction: props.direction ? props.direction : 'horizontal',
    theme: theme ? theme : null
  }, props), props.children), props.children && props.children.length > 1 && props.children.map((child, index) => /*#__PURE__*/React.createElement(MenuChildDiv, _extends({
    alignment: props.alignment ? props.alignment : 'left',
    className: "af-menu-child",
...
export { Button, Column, Container, Header, Heading, Input, Link, Logo, Menu, Modal, Page, Paragraph, Section, ThemeProvider };
